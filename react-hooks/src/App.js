...
function App() {
  return (
    <>
      ...
      <BrowserRouter>
        <ul>
          <li><Link to="teste1">Teste 1</Link></li>
          <li><Link to="teste2">Teste 2</Link></li>
          <li><Link to="ex01">Exercício 01</Link></li>
          <li><Link to="ex02">Exercício 02</Link></li>
          <li><Link to="ex03">Exercício 03</Link></li>
          <li><Link to="ex04">Exercício 04</Link></li>
          <li><Link to="ex05">Exercício 05</Link></li>
          <li><Link to="ex06">Exercício 06</Link></li>
        </ul>
        ...
        <div style={{border: '1px solid blue', padding: '20px' }}>
          <Switch>
            ...
            <Route path="/ex01"><Exercicio01 /></Route>
            <Route path="/ex02"><Exercicio02 /></Route>
            <Route path="/ex03"><Exercicio03 /></Route>
            <Route path="/ex04"><Exercicio04 /></Route>
            <Route path="/ex05"><Exercicio05 /></Route>
            <Route path="/ex06"><Exercicio06 /></Route>
          </Switch>
        </div>
      </BrowserRouter>
    </>
